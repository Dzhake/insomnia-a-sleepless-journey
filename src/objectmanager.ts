...
import { Enemy, getEnemyType } from "./enemy.ts";
import { nextObject, WeakGameObject } from "./gameobject.ts";
import { StrongInteractionTarget, WeakInteractionTarget } from "./interactiontarget.ts";
...
import { HintTrigger } from "./hinttrigger.ts";
